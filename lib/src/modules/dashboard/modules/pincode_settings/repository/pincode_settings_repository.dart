...
class PincodeSettingsRepository {
  ...
  Future<PincodeModel> getPincodes() async {
    try {
      ...
      return const PincodeModel(status: false, message: 'Invalid response format from server.', data: []);
    } catch (e, stackTrace) {
  ...
  Future<AddPincodeModel> addPincode(Map<String, dynamic> payload) async {
    try {
      ...
      return const AddPincodeModel(success: false, message: 'Invalid response format from server.');
    } catch (e, stackTrace) {
  ...
  Future<UnmapAndAssignPincodeModel> unmapAndAssignPincode(Map<String, dynamic> payload) async {
    try {
      ...
      return const UnmapAndAssignPincodeModel(success: false, message: 'Invalid response format from server.');
    } catch (e, stackTrace) {
